    ...
    public class Heap<T>
    {
        ...
        public void SiftUp(int index)
        {
            while (index > 0)
            {
                ...
                if (ToSwap(array[index], array[parentIndex]))
                {
        ...
        public void SiftDown(int index)
        {
            while (index * 2 + 1 < size)
            {
                ...
                if (rightIndex < size && ToSwap(array[rightIndex], array[leftIndex]))
                {
                    minChildIndex = rightIndex;
                }

                if (ToSwap(array[index], array[minChildIndex]))
                {
                    break;
                }
                else
        ...
        private bool ToSwap(T element1, T element2)
        {
